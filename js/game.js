let button = document.querySelector('#buttonGame');
...
function startTimerSkidka() {
  timerSkidka = setInterval(function() {
...
var crash = document.getElementById("myAudioCrash");
...
var roads = 
[
	new Road("img/images_game/road.jpg", 0),
	new Road("img/images_game/road.jpg", canvas.width)
]; //Backgrounds

var player = new Car("img/images_game/car.png", canvas.width / 2, canvas.height / 2, true); //Player's object
...
var gameOver = document.querySelector('#buttonClose');

gameOver.addEventListener('click', Stop);
...
function Update() 
{
	...
	{
		objects.push(new Car("img/images_game/car_red.png", RandomInteger(30, canvas.width - 50), RandomInteger(250, 400) * -1, false));
	}
